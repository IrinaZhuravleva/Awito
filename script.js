...
console.log('elementsModalSubmit: ', elementsModalSubmit);
...
// elementsModalSubmit.forEach(console.log);
...
//         target === this) {
//         //this - элемент, на который навешано событие, а их у нас два
...
// либо мы подставляем DB, а если DB (или что-то еще, как, напрм, result ниже) не прописано, то вставляется База Данныъ - dataBase 
//появилось в js в2015
...
searchInput.addEventListener('input', () => {
    ...
    if (valueSearch.length > 2) {
        ...
        //рендерить на лету без очистки контейнера
        renderCard(result);
    }
});
...
const closeModalEscape = event => {
    ...
    // console.log('close'); //срабатывает только когда открыто модальное окно
